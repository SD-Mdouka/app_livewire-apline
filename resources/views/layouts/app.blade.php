            ...
            <ul class="flex flex-col md:flex-row items-center">
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="{{ route('movies.index') }}" class="hover:text-gray-300">
                        <div>Applcation Movies</div>
                    </a>
                </li>
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="{{ route('movies.index') }}" class="hover:text-gray-300 hover">Movies</a>
                </li>
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="{{ route('tv.index') }}" class="hover:text-gray-300 hover">TV Show</a>
                </li>
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="{{ route('actors.index') }}" class="hover:text-gray-300 hover">Actors</a>
                </li>
            </ul>
            <div class="font-sans flex flex-col md:flex-row items-center">
